...
const FRAMES = [
  { photo: "photo-golden", caption: "12:47 · האחוזה מוארת ע״י השמש האחרונה. נועה לבד בחדר ההכנות. דקה לפני שכולם נכנסים." },
  { photo: "photo-rose", caption: "13:22 · סבתא מחבקת אותה לראשונה כלה. אני עוד לא יכולה לדבר אבל המצלמה כן." },
  { photo: "photo-honey", caption: "14:08 · הם הולכים לחופה. שני זוגות נעליים, רעיון שלם של חיים שמתחיל פה." },
  { photo: "photo-blue", caption: "16:55 · הריקוד הראשון שלהם. כל האורחים יושבים. הם בלעדיהם, רק שניהם." },
  { photo: "photo-noir", caption: "23:41 · הריקוד הסוער של החברים. הקצב כל-כך גבוה שהמצלמה צריכה להתחנן." },
  { photo: "photo-candle", caption: "01:17 · השמיים פתוחים מעל הגן. הם נשארים אחרונים. תמיד יש את הרגע הזה." },
];
