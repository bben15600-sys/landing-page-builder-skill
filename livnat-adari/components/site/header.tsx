      ...
      <div className="mx-auto flex h-16 max-w-6xl items-center justify-between gap-4 px-4 md:px-6">
        <a href="#top" className="flex items-center gap-2.5">
          ...
          <span className="flex flex-col leading-none">
            ...
            <span className="text-[10px] font-semibold tracking-[0.18em] text-muted-foreground md:text-[11px]">
              {site.brandSuffix}
            </span>
          </span>
        </a>
        ...
        <div className="flex items-center gap-2">
          ...
          >
            ...
            <span className="sm:hidden">התקשרי</span>
          </Button>
                ...
                {nav.map((item) => (
                  <SheetClose
                    ...
                    render={
                      <a
                        href={item.href}
                        className="rounded-lg px-3 py-3 text-base font-medium text-foreground/80 transition-colors hover:bg-accent hover:text-accent-foreground"
                      />
                    }
                  >
                    {item.label}
