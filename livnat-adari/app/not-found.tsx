...
export default function NotFound() {
  return (
    <main className="relative flex flex-1 flex-col items-center justify-center overflow-hidden px-4 py-24 text-center">
      ...
      <BrandMark className="size-16 rounded-2xl" iconClassName="size-10" />

      <p className="mt-8 text-7xl font-extrabold tracking-tight text-primary md:text-8xl">
        404
      </p>
      ...
      <p className="mt-3 max-w-md text-muted-foreground">
        ייתכן שהקישור שגוי או שהעמוד הוסר. חזרי לדף הבית או דברי איתי ישירות.
      </p>
